        ...
        <>
          ...
          >
            <div className="flex justify-between items-center mb-8">
              <h2 className="text-xl font-bold tracking-tight text-fg">Edit Payment</h2>
              <button
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-6 pb-12">
              <div className="grid grid-cols-2 gap-4">
                <div className="min-w-0">
                  <label className="block text-[10px] uppercase tracking-widest font-semibold text-subtle mb-3">Amount (₹)</label>
                  <input
                    type="number"
                    step="0.01"
                    required
              ...
              <div>
                <label className="block text-[10px] uppercase tracking-widest font-semibold text-subtle mb-3">Note</label>
                <textarea
                  value={note}
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <button
                  type="submit"
                  disabled={submitting || isDeleting}
                  className="w-full bg-emerald-500 hover:bg-emerald-400 text-white font-bold tracking-widest uppercase text-sm rounded-2xl py-5 mt-4 transition-colors disabled:opacity-50 shadow-md dark:shadow-[0_10px_30px_rgba(16,185,129,0.3)]"
                >
